return {
    ...
    misc = {
        ...
        dictionary = {
            ...
            b_vanilla_run_select = 'Usar el seleccionador de partida original',
            b_vanilla_run_select_info = { 'Esta opción es ignorada si', 'un mod añade páginas extra' },
            b_run_select_reduce = 'Modo de alto rendimiento para el seleccionador de partida',
            b_run_select_reduce_info = { 'Reduce el número de cartas mostradas', 'y remueve animaciones' },
            b_vanilla_stake = 'Usar el visualizador de pozos original',
            b_vanilla_stake_info = { 'Cambia el visualizador de pozos', 'en el menú de Partida Info' },
            b_author = 'Autor/a',
            b_authors = 'Autores',
            ...
            k_enhanced = 'Mejora',
            run_select_locked_stake = "Bloqueada",
            run_select_locked_stake_message = "Gana con esta baraja usando el ",
            ...
            run_select_stake_choice = 'Elegir pozo',
            run_select_deck_choice_random = 'Baraja aleatoria',
            run_select_stake_choice_random = 'Pozo aleatorio',
        },
        v_dictionary = {
            c_types = '#1# Tipos',
