return {
    ...
    misc = {
        ...
        dictionary = {
            ...
            b_vanilla_run_select = 'Use Vanilla Run Select',
            ...
            b_vanilla_stake = 'Use Vanilla Stake Display',
            b_vanilla_stake_info = {'Toggles the custom display', 'of stakes in run info'},
            b_author = 'Author',
            b_authors = 'Authors',
            b_unknown = 'Unknown',
