...
--- ! Injected by QuantumCardField.inject
--- Redirects to Card:set_ability()
---@param center string See Card:set_ability()
---@param initial boolean|nil See Card:set_ability()
---@param delay_sprites boolean|nil See Card:set_ability()
function Card:set_enhancement(center, initial, delay_sprites) end
...
--- ! Injected by QuantumCardField.inject
---@param value string|nil Key of the seal to set, or nil to remove the card's seal.
---@param args table|boolean|nil Args table, used flags: [immediate: whether to set it in an event, silent: whether to play sounds AND whether it is instant (overrules immediate), delay: ?] 
---@param immediate table|nil ^ legacy compat 
function Card:set_seal(value, args, immediate) end
...
--- ! Injected by QuantumCardField.inject
---@param value string|nil Key of the Edition to set, or nil to remove the card's Edition.
---@param args table|boolean|nil Args table, used flags: [immediate: whether to set it in an event, silent: whether to play sounds AND whether it is instant (overrules immediate), delay: ?] 
---@param silent boolean|nil ^ legacy compat 
---@param delay boolean|nil ^ legacy compat 
function Card:set_edition(value, args, silent, delay) end
...
--- Redirects to Card:set_ability()
---@param center string See Card:set_ability()
---@param initial? boolean See Card:set_ability()
---@param delay_sprites? boolean See Card:set_ability()
function Card:set_enhancement(center, initial, delay_sprites) end
...
--- ! Injected by QuantumCardField.inject
---@param value string Args table, used flags: [as_objs: Whether to return objs or obj keys.] 
---@param args? table|nil Args table, used flags: [as_objs: Whether to return objs or obj keys.] 
function Card:set_seal(value, args, immediate) end
