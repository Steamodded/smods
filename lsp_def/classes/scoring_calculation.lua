...
---@field upgrade_hand? fun(self: SMODS.Scoring_Parameter, amount: number, hand: table, behavior?: string|function) Handle how to upgrade this parameter's base value for a specific poker hand. If `behavior` is a function, it must take the current base value of the parameter and `amount` as arguments, in that order, and return the desired base value of the parameter.
