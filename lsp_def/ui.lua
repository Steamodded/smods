...
---@field shader UINode.shader_config|string|(UINode.shader_config|string)[] Defines what shaders are used. If a string, uses that string as the key and sends default arguments.
